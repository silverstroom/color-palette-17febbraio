...
export default function PaletteCard({ palette, clientName, onDownload }) {
  ...
  // Determine if the download bar should have a dark theme
    ...
    <div className="group">
      ...
      >
        ...
        >
          ...
          <span
            className="font-mono text-[13px] font-bold uppercase tracking-wider px-5 py-1.5 rounded-lg"
