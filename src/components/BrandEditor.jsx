...
export default function BrandEditor({ brand, onChange, savedClients, onSave, onLoad, onDelete }) {
        ...
        {savedClients.length > 0 && (
          <div className="space-y-2">
            ...
            {savedClients.map((c) => (
              <div
                key={c.id}
                className="flex items-center gap-2 bg-slate-800/40 rounded-lg p-2 group/item"
              >
                <button
                  onClick={() => onLoad(c)}
                ...
                <div className="flex gap-1">
                  <div
                    className="w-5 h-5 rounded-md border border-slate-600/40"
