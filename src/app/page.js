...
export default function Home() {
  ...
  const handleLoadTermitalia = () => {
    setBrand(PRESET_TERMITALIA);
    setLogo(null);
    setReferences([]);
  };
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* ── MAIN CONTENT ── */}
      <main
        className={`flex-1 transition-all duration-300 ${sidebarOpen ? 'ml-[360px]' : 'ml-0'}`}
      >
        {/* Hero bar */}
